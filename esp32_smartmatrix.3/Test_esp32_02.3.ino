...
const uint8_t kPanelType = SM_PANELTYPE_HUB75_32ROW_32COL_MOD8SCAN;   // Choose the configuration that matches your panels.  See more details in MatrixCommonHub75.h and the docs: https://github.com/pixelmatix/SmartMatrix/wiki
